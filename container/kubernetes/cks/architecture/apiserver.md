...
- [CKS - Architecture](#cks---architecture)
  - [](#)
...
#      Active: active (running) since Fri 2026-09-04 09:15:17 EDT; 18min ago
#        Docs: https://kubernetes.io/docs/concepts/overview/components/
#    Main PID: 1150 (kube-apiserver)
#       Tasks: 10 (limit: 3179)
#      Memory: 460.0M (peak: 495.1M)
#         CPU: 1min 25.994s
#      CGroup: /system.slice/kube-apiserver.service

# unit file: binary /usr/local/bin/kube-apiserver; etcd:https://127.0.0.1:2379
...
ll -h /usr/local/bin/
# total 434M
# drwxr-xr-x  2 root root 4.0K Sep  3 22:52 ./
# drwxr-xr-x 10 root root 4.0K Aug 27  2024 ../
# -rwxr-xr-x  1 1001 1001  38M Dec 10  2025 crictl*
# -rwxr-xr-x  1 root root  26M Sep  3 22:28 etcd*
# -rwxr-xr-x  1 root root  17M Sep  3 22:28 etcdctl*
# -rwxr-xr-x  1 root root  83M Sep  3 22:33 kube-apiserver*
# -rwxr-xr-x  1 root root  70M Sep  3 22:40 kube-controller-manager*
# -rwxr-xr-x  1 root root  57M Sep  3 22:34 kubectl*
# -rwxr-xr-x  1 root root  57M Sep  3 22:48 kubelet*
# -rwxr-xr-x  1 root root  42M Sep  3 22:52 kube-proxy*
# -rwxr-xr-x  1 root root  47M Sep  3 22:45 kube-scheduler*
```
