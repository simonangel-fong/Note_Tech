...
docker run -d -it --name oracledbcon -p 1521:1521 -p 5500:5500 -e ORACLE_PDB=pdb1 -e ORACLE_PWD=SecurePassword!234 -v oracledata:/opt/oracle/oradata -v C:\\Users\\simon\\OneDrive\\Tech\\Github\\DBA_Toronto_Shared-Bike_Ridership\\data:/tmp simonangelfong/database-repo:v1.0
```
