...
- [Linux - System: Log](#linux---system-log)
  ...
  - [Logging Custom Messages](#logging-custom-messages)
  - [journalctl command](#journalctl-command)
    - [Preserving Journal Information](#preserving-journal-information)
...
- default is under the `/var/log/journal` directory
  - need to create the `/var/log/journal` directory manually
