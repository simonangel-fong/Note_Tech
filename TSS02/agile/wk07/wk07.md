...
| ------------------------------------------------------------ | --------------------------------------------------------------- |
| User Stories,in points                                       | Tasks, in units of time                                         |
| an extensive list of all stories or features for the project | consists of the highest priority items to be done in the sprint |
